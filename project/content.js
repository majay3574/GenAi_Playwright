...
function selectElement(e) {
  ...
  const nthOfTypeCss = generateNthOfTypeCss(element);

  const finalSelector = stableXPath || stableCss || nthOfTypeCss || generateFullXPath(element);
  const selectorType = stableXPath ? 'xpath' : (stableCss || nthOfTypeCss) ? 'css' : 'xpath';
...
function generateNthOfTypeCss(el) {
